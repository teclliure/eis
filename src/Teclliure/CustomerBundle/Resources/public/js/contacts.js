...
var collectionHolder = $('table#customerContacts tbody');
...
function addLineFormDeleteLink($lineFormLi) {
    var $removeFormA = $('<a class="delete_contact_link" href="#"><i class="icon-remove-circle"></i></a>');
    $lineFormLi.children('.lineName').prepend($removeFormA);
